...
# Change Class column into Class_0 ([1 0] for legit data) and Class_1 ([0 1] for
#fraudulent data)
...
# Applies a logit weighting of 578 (1/0.0017) to fraudulent transactions to
# cause model to pay more attention to them
...
# Third layer takes in input from 2nd layer and outputs [1 0] or [0 1] depending on
#fraud vs legit
weight_3_node = tf.Variable(tf.zeros([num_layer_2_cells, output_dimensions]), name='weight_3')
biases_3_node = tf.Variable(tf.zeros([output_dimensions]), name='biases_3')


# Function to run an input tensor through the 3 layers and output a tensor that will give
#us a fraud/legit result
# Each layer uses a different function to fit lines through the data and predict whether
#a given input tensor will \
